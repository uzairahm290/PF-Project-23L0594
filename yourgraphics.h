...
void drawRectangle(int x1, int yz1, int x2, int y2, int R, int G, int B, int FR, int FG, int FB ); // draws a rectangle using top-left and bottom-right x-y coordinates with separate border and fill colours
...
void gotoxy(double x,double y); // sets console cursor on given x-y coordinates
